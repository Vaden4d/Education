...
class DynamicUnet(nn.Module):
    ...
    def __init__(self, encoder, last=True, n_classes=3):
        ...
        self.encoder_children = list(encoder.children())
        self.n_children = len(list(encoder.children()))
        self.sfs = [SaveFeatures(self.encoder_children[i]) for i in range(self.n_children)]
        self.last = last
...
if __name__ == '__main__':
    ...
    enc = Architecture()
    print(list(enc.named_children())[0][1])
    #dec = DynamicUnet(enc)
    #print('Enc')
    #summary(enc, (1, 101, 101))
    #print('Dec')
    #summary(dec, (5, 47, 47))